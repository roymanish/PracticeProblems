...
public class TestCustomSerialization
{
    public static void main(String[] args)
    {
        ...
        props.put("Religion", "Hindu");
        
        myDetails.setProps(props);
        
        myDetails.setLanguage("English");
        
        myDetails.setPrime(new PrimeUser("Indian"));
        // Serialization code
        try
        {
        ...
        try
        {
            ...
            System.out.println(deserializedUser.getProps());
            System.out.println(deserializedUser.getPrime());
            System.out.println(deserializedUser.getLanguage());
        }
